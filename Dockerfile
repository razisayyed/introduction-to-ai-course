...
# set runner ENV
ENV MIX_ENV="prod"
ENV SECRET_KEY_BASE="shhxDpquM8UY2IzVFPZR7cQbEzov41hDRdBu1Q+DsaBugHRtWFWR97ItJ+5mb8W5"

# Only copy the final release from the build stage
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/ai_course ./
